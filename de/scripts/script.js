...
function fixLinkPaths() {
    ...
    document.addEventListener('click', function(event) {
        ...
        if (target) {
            ...
            // Check if we're on a German language page
            ...
            if (isGermanPage) {
                ...
                // Handle absolute root links that should be prefixed with /de/
                if (href.startsWith('/') && !href.startsWith('/de/')) {
                    event.preventDefault();
                    const newPath = window.location.origin + '/de' + href;
                    window.location.href = newPath;
                }
                // Handle links like /list.html#text-tools that should become /de/list.html#text-tools
                else if (href.startsWith('/list.html#') && !href.startsWith('/de/list.html#')) {
                    event.preventDefault();
                    const newPath = window.location.origin + '/de' + href;
                    window.location.href = newPath;
                }
