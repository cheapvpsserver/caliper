...
function initRelatedTools(currentSlug) {
    ...
    const toolIcons = {
            "Analizador de texto": "fas fa-chart-pie",
            "Herramienta acortadora de texto": "fas fa-compress-alt",
            "Contador de palabras y caracteres en línea": "fas fa-list-ol",
            "Formateador de texto": "fas fa-align-justify",
            "Eliminación de texto duplicado": "fas fa-clipboard-check",
            "Eliminar etiquetas HTML": "fas fa-code",
            "Convertidor de mayúsculas/minúsculas de texto": "fas fa-text-height",
            "Generador de inversión de texto": "fas fa-sync-alt",
            "Ordenar líneas de texto": "fas fa-sort-numeric-down",
            "Divisor de texto y palabras": "fas fa-cut",
            "Herramienta combinadora de texto": "fas fa-file-alt",
            "Reemplazo de caracteres de texto": "fas fa-search",
            "Analizador de densidad de palabras clave": "fas fa-chart-bar",
            "Convertidor de imágenes": "fas fa-exchange-alt",
            "Redimensionador de imágenes": "fas fa-expand-arrows-alt",
            "Compresor de imágenes": "fas fa-compress",
            "Herramienta de filtros y efectos de imagen": "fas fa-magic",
            "Herramienta de anotación de imagen": "fas fa-pen",
            "Herramientas de píxeles y colores de imagen": "fas fa-palette",
            "Herramienta combinadora y divisora de imágenes": "fas fa-object-group",
            "Herramienta de fondo y máscara": "fas fa-layer-group",
            "Metadatos e información de imagen": "fas fa-info-circle",
            "Visor de metadatos de vídeo": "fas fa-info-circle",
            "Calculadora de tamaño de archivo de vídeo": "fas fa-calculator",
            "Comprobador de duración de vídeo": "fas fa-stopwatch",
            "Detector de tipo MIME de vídeo": "fas fa-magic",
            "Comprobador de información de contenedor de vídeo": "fas fa-box-open",
            "Extractor de fotogramas de vídeo": "fas fa-camera-retro",
            "Generador de miniaturas de vídeo": "fas fa-images"
        };
    ...
    // Remove language code (es) from path for relative path calculation
        ...
        .then(tools => {
            ...
            if (current) {
                ...
                if (related.length > 0) {
                    ...
                    container.innerHTML = '<p class="text-center text-gray-500">No se encontraron herramientas relacionadas.</p>';
                }
            } else {
                console.error('Current tool not found with slug:', currentSlug);
                const container = document.getElementById('relatedTools');
                container.innerHTML = '<p class="text-center text-gray-500">Error al cargar las herramientas relacionadas.</p>';
            }
        })
        .catch(error => {
